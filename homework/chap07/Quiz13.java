...
(2) 定义一个类PassObject，在类中定义一个方法printAreas()，该方法的定义如下：
     public void printAreas(q5.Circle c, int times) 	//方法签名/声明
...
class PassObject {
    public void printAreas(q5.Circle c, int times) {
        //打印范围内每个半径及面积
        //打印header
        System.out.println("Radius\tArea");
        for(int r = 1; r <= times; ++r) {
            //使用Circle类的方法计算面积
            // c = new q5.Circle(); !!!如有此句，main运行的当前半径是0.0
            c.setRadius(r);
